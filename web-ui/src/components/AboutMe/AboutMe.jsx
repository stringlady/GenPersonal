    ...
    return (
        <div id='aboutme'>
            <div className='aboutme2'>
                <p>I am a dedicated student pursuing a Bachelor of Arts degree in English with a Minor in Africana Studies at Bates College, set to graduate in May 2024. Throughout my academic journey, I have cultivated a strong skill set as a copy editor and proofreader.</p>
